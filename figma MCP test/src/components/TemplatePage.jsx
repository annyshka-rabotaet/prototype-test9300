      ...
      <div className="template-viewer">
        ...
        <aside className="viewer-sidebar">
          <div className="sidebar-content">
            <h2 className="sidebar-title">Car Rental Agreement Template</h2>
            ...
            <div className="promo-box">
              <h3>Sign up to use this winning template</h3>
              <ul className="promo-list">
                <li>Add images, video, pricing tables, and more.</li>
                <li>Track opens, views, and time spent on each page.</li>
                <li>Apply a document theme that matches your company brand.</li>
              </ul>
              <button className="promo-btn" onClick={onUseTemplate}>Try it free</button>
              <p className="promo-note">No credit card required</p>
            </div>
          </div>
        </aside>
      </div>
